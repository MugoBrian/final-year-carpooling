            ...
            <div className={"main-buttons"}>
              ...
              {/* <Link to='/active-trip'>
                                <Button variant='warning' className={activeTrip ? 'main-button' : 'hidden'} disabled={'/active-trip' === location.pathname} data-test="activeTrip-button">
                                    <AiIcons.AiOutlineCar style={{ color: 'white', marginBottom: '0.1rem', marginRight: '0.3rem' }} data-test='activeTrip-icon' /> Active Trip
                                </Button>
                            </Link> */}
              <Link to="/drive">
                <Button
                ...
                >
                  <AiIcons.AiTwotoneCar
                    style={{ color: "black", marginBottom: "0.1rem" }}
            ...
            <ul className="sidebar-bottom-items" onClick={showSidebar}>
              <li className="nav-text" data-test="logout-button">
                <Link to="/login" onClick={handleLogOut}>
                  {" "}
                  {/*call logout method*/}
                  <FaIcons.FaSignOutAlt color="white" />
