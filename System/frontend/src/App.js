...
function App() {
  ...
  if (loadError) return <h3 className="text-red">Error Loading The Map</h3>;
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            token ? (
              <Profile setToken={setToken} setActiveTrip={setActiveTrip} />
            ) : (
              <Navigate to="/login" />
            )
          }
        ...
        <Route
          ...
          element={
            token ? (
              <Drive setToken={setToken} setActiveTrip={setActiveTrip} />
            ) : (
              <Navigate to="/login" />
            )
          }
        ...
        <Route
          ...
          element={
            token ? (
              <RideRequest setToken={setToken} setActiveTrip={setActiveTrip} />
            ) : (
              <Navigate to="/login" />
            )
          }
        ...
        <Route
          ...
          element={
            token ? (
              <DriveRequest setToken={setToken} setActiveTrip={setActiveTrip} />
            ) : (
              <Navigate to="/login" />
            )
          }
