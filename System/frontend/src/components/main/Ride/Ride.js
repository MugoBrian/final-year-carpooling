      ...
      {finding ? (
        ...
        <>
          <Container fluid="lg">
            <Row style={{ marginTop: "3rem" }}>
              <Col md>
                <Row className="p-2">Select an option for car pooling</Row>
                {trips.map((trip) => {
                  return (
                          ...
                          {typeof calculationData != "undefined" &&
                            ...
                            calculationData != {} && (
                              <>
                                ...
                                <div>
                                  <b>Estimated Pickup Date:</b>{" "}
                                  {calculationData.pickUpDateTime?.toLocaleDateString(
                                    "en-US"
                                  ) || ""}
                                </div>
                                <div>
                                  <b>Estimated Pickup Time:</b>{" "}
                                  {calculationData.pickUpDateTime?.getHours() +
                                    " : " +
                                    calculationData.pickUpDateTime?.getMinutes() ||
                                    ""}
                                </div>
                                <div>
                                ...
                                <div>
                                  <b>Estimated Drop off Date:</b>{" "}
                                  {calculationData.destinationDateTime?.toLocaleDateString(
                                    "en-US"
                                  ) || ""}
                                </div>
                                <div>
                                  <b>Estimated Drop off Time:</b>{" "}
                                  {calculationData.destinationDateTime?.getHours() +
                                    " : " +
                                    calculationData.destinationDateTime?.getMinutes() ||
                                    ""}
                                </div>
                                <div>
